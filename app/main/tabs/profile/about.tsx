      ...
      <ScrollView style={styles.scrollContainer} showsVerticalScrollIndicator={false}>
        <View style={styles.logoContainer}>
          <Image
            ...
            style={styles.logo}
            defaultSource={require('../../../../assets/images/login.jpg')}
          />
        ...
        <View style={styles.sectionContainer}>
          ...
          <Text style={styles.sectionText}>
            Founded in 2020, our company began with a simple idea: to make technology more 
        ...
        <View style={styles.socialContainer}>
          ...
          <View style={styles.socialIcons}>
            <TouchableOpacity style={styles.socialIcon} activeOpacity={0.7}>
              <MaterialIcons name="facebook" size={28} color={Colors.primary} />
            </TouchableOpacity>
            <TouchableOpacity style={styles.socialIcon} activeOpacity={0.7}>
              <MaterialIcons name="twitter" size={28} color={Colors.primary} />
            </TouchableOpacity>
            <TouchableOpacity style={styles.socialIcon} activeOpacity={0.7}>
              <MaterialIcons name="instagram" size={28} color={Colors.primary} />
            </TouchableOpacity>
            <TouchableOpacity style={styles.socialIcon} activeOpacity={0.7}>
              <MaterialIcons name="linkedin" size={28} color={Colors.primary} />
            </TouchableOpacity>
          </View>
        </View>

        <View style={styles.footer}>
          <Text style={styles.footerText}>© {new Date().getFullYear()} Your Company Name. All rights reserved.</Text>
        </View>
      </ScrollView>
    </View>
  );
